...
//pass
test.skip('TC_PSP_01_VerifySubscribePageNavigation', async ({ page }) => {
  await page.goto('https://shop.tech-vip.com/');
...
//failed due to captcha dialog box issue
test.skip('TC_PSP_06_VerifyProductOrderOnBackend', async ({ page }) => {
  await page.goto('https://shop.tech-vip.com/');
  await page.waitForLoadState('networkidle');
  await expect(page.getByRole('link').filter({ hasText: /^$/ })).toBeVisible();
  await expect(page.getByRole('link', { name: 'PRIX VIP −50% Crochets adhé' })).toBeVisible();
...
//failed due to captcha dialog box issue
test.skip('TC_PSP_13_VerifyProductOrderRefundOnBackend', async ({ page }) => {
  await page.goto('https://shop.tech-vip.com/');
  await page.waitForLoadState('networkidle');
  await expect(page.getByRole('link').filter({ hasText: /^$/ })).toBeVisible();
  await expect(page.getByRole('link', { name: 'PRIX VIP −50% Crochets adhé' })).toBeVisible();
...
//pass
test.skip('TC_PSP_15_VerifyCompanyNameOnLegalTerms', async ({ page }) => {
  await page.goto('https://shop.tech-vip.com/');
  await page.waitForLoadState('networkidle');
