...
//		  String expectedMerciContent = productDescription.get(33).toString();
					...
					// String actualProductBreadCrumb =
					// productDescriptionPage.getProductManagerBreadCrumb();
					...
					// String expectedMcafreeImage =
					// "https://boutik-prive.fr/assets/l120/img/payment/mcafee.png";
					// String actualMcafreeImage = productDescriptionPage.getMCFeeImageSrc();
					// String expectedTrusteImage =
					// "https://boutik-prive.fr/assets/l120/img/payment/TRUSTe.png";
					// String actualTrusteImage = productDescriptionPage.getTrusteImageSrc();
					// String expectedVerisignImage =
					// "https://boutik-prive.fr/assets/l120/img/payment/verisign.png";
					// String actualVerisignImage = productDescriptionPage.getVerisignImageSrc();

					// if (actualMcafreeImage.equals(expectedMcafreeImage)) {
					// Report.pass("'" + expectedMcafreeImage + "' image on Product Description
					// Page.", getScreenshot(getDriver()));
					// } else {
					// Report.fail("Expected <b>'" + expectedMcafreeImage + "'</b> but found <b>'" +
					// actualMcafreeImage + "'</b> image on Product Description Page.",
					// getScreenshot(getDriver()));
					// }

					// if (actualTrusteImage.equals(expectedTrusteImage)) {
					// Report.pass("'" + expectedTrusteImage + "' image on Product Description
					// Page.", getScreenshot(getDriver()));
					// } else {
					// Report.fail("Expected <b>'" + expectedTrusteImage + "'</b> but found <b>'" +
					// actualTrusteImage + "'</b> image on Product Description Page.",
					// getScreenshot(getDriver()));
					// }
					...
					// + actualVerisignImage + "'</b> image on Product Description Page.",
					// getScreenshot(getDriver()));
					// }
					...
					if (actualHowItWorks2Text.equals(expectedHowItWorks2Text)) {
						...
						Report.fail(
								"Expected <b>'" + expectedHowItWorks2Text + "'</b> but found <b>'"
										+ actualHowItWorks2Text + "'</b> How it works 2 text on Payment Page.",
								getScreenshot(getDriver()));
					}
					...
					if (merciContent0.equals(expectedMerciContent1)) {
						...
						Report.fail("Expected <b>'" + expectedMerciContent1 + "'</b> but found <b>'" + merciContent0
								+ "'</b> text on Merci Page.", getScreenshot(getDriver()));
					}
					...
					if (passwordText.matches(expectedPasswordRegexPattern)) {
						...
						Report.fail("Expected <b>'" + passwordText + "'</b> but found <b>'"
								+ expectedPasswordRegexPattern + "'</b> text on Merci Page.",
								getScreenshot(getDriver()));
					}
					...
					if (merciContent1.equals(expectedMerciContent2)) {
						...
						Report.fail("Expected <b>'" + expectedMerciContent2 + "'</b> but found <b>'" + merciContent1
								+ "'</b> text on Merci Page.", getScreenshot(getDriver()));
					}
