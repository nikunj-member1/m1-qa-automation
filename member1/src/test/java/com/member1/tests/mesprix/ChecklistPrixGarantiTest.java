...
public class ChecklistPrixGarantiTest extends BaseDriverManager {
	...
	public void TC_PSP_01_VerifySubscribePageNavigation() {
		...
		try {
			...
			Report.info("Open " + PRIXGARANTI_URL + " in " + BROWSER_NAME + " browser.");

			HomePage homePage = new HomePage(getDriver());

			homePage.navigateURL(PRIXGARANTI_URL);
			...
			Report.info("Click on Prix garanti logo on Header.");
			headerFooter.clickOnPrixGarantiLogo();
	...
	public void TC_PSP_02_VerifyEmailAfterPurchaseMembership() {
		...
		//	String subscriptionPlanName = "S’abonner pour 25€/mois en prélèvement trimestriel (75€/trimestre)";
			...
			String websiteName = "Prix-Garanti";
			...
			String expectedSubscriptionPriceText = Enums.PrixGarantiDetails.MONTH_PRICE.getValue(); 
			...
			String expectedWebsiteLegalAddressDetails = Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue(); 
			...
			String expectedWebsiteLegalEmail = Enums.PrixGarantiDetails.EMAIL.getValue(); 
			...
			String expectedWebsiteHelpSectionEmail = Enums.PrixGarantiDetails.EMAIL.getValue(); 
			...
			String expectedWebsiteHelpSectionContactNumber = Enums.PrixGarantiDetails.CONTACT_NUMBER.getValue(); 
	...
	public void TC_PSP_05_TC_PSP_07_VerifyEmailAfterPurchaseProduct() {
		...
		try {
			...
			String productUrl = "https://prix-garanti.com/product/pompe-a-vide-pour-vin-tm-electron-2-pcs/";			
			...
			String expectedProductTitle = "Pompe à vide pour vin TM Electron (2 pcs)";
...
//			}		
			...
			if (mailDropPage.isCompanyEmailNameTextDisplayed()) {
				Report.pass("'Natalie Lemieux <boutique@prix-garanti.com>' text on MailDrop page.", getScreenshot(getDriver()));
			} else {
				Report.fail("'Natalie Lemieux <boutique@prix-garanti.com>' text on MailDrop page.", getScreenshot(getDriver()));
			}
	...
	//fail card issue - backend dashboard issue
	@Test
...
//			}		
			...
			String backendURL = PRIXGARANTI_URL + "wp-admin/";
			
			Report.info("Navigate to '"+backendURL+"' url on browser.");
			loginPage.navigateToWebsiteBackEnd(backendURL);		
						
			if (loginPage.isPrixGarantiLogoDisplayed()) {
				Report.pass("Prix Garanti logo on Login page.", getScreenshot(getDriver()));
			} else {
				Report.fail("Prix Garanti logo on Login page.", getScreenshot(getDriver()));
			}
...
//			}		
	...
	public void TC_PSP_15_VerifyCompanyNameOnLegalTerms() {
		...
		try {
			...
			// Home page > Header
			String email = Enums.PrixGarantiDetails.EMAIL.getValue();			
			...
			String contactNumber = Enums.PrixGarantiDetails.CONTACT_NUMBER.getValue();
			...
			String monthPrice = Enums.PrixGarantiDetails.MONTH_PRICE.getValue();
			...
			// Home page > Footer
			String companyNameWithAddress = Enums.PrixGarantiDetails.COMPANY_NAME.getValue() + " " + Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue();
			int actualCompanyNameWithAddressCount = headerFooter.getCompanyFullAddressCountOnFooter(Enums.PrixGarantiDetails.COMPANY_NAME.getValue(),Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
			...
			email = Enums.PrixGarantiDetails.EMAIL.getValue();			
			...
			contactNumber = Enums.PrixGarantiDetails.CONTACT_NUMBER.getValue();
			...
			companyNameWithAddress = Enums.PrixGarantiDetails.COMPANY_NAME.getValue() + " " + Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue();
			actualCompanyNameWithAddressCount = headerFooter.getCompanyFullAddressCountOnFooter(Enums.PrixGarantiDetails.COMPANY_NAME.getValue(),Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
		...
		//	getDriver().switchTo().alert().accept();
			...
			actualCompanyNameWithAddressCount = membershipPage.getCompanyAddressCountOnModal(Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			actualCompanyNameWithAddressCount = membershipPage.getCompanyNameWithAddressCountOnModal(Enums.PrixGarantiDetails.COMPANY_NAME.getValue(),Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			bothPrice = Enums.PrixGarantiDetails.BOTH_PRICE.getValue();
			...
			bothPrice = Enums.PrixGarantiDetails.MONTH_TRIMESTER.getValue();
			actualPriceCount = membershipPage.getBothPriceCountOnModal(bothPrice);
			expectedPriceCount = 1;
...
//			}
			...
			String companyName = Enums.PrixGarantiDetails.COMPANY_NAME.getValue();
			int actualCompanyNameCount = personalDataPage.getCompanyNameCount(Enums.PrixGarantiDetails.COMPANY_NAME.getValue());
			...
			String companyAddress = Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue();
			...
			actualCompanyNameWithAddressCount = personalDataPage.getCompanyNameWithAddressCount(Enums.PrixGarantiDetails.COMPANY_NAME.getValue(),Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			actualCompanyNameWithAddressCount = generalConditionPage.getCompanyNameAndAddressCount(Enums.PrixGarantiDetails.COMPANY_NAME.getValue(),Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
			...
			actualCompanyNameWithAddressCount = generalConditionPage.getCompanyNameWithAddressCount(Enums.PrixGarantiDetails.COMPANY_NAME.getValue(),Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			int actualCompanyNameAndAddressCount = paymentPage.getCompanyNameAndAddressCount(Enums.PrixGarantiDetails.COMPANY_NAME.getValue(),Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
			...
			actualCompanyNameWithAddressCount = paymentPage.getCompanyNameWithAddressCount(Enums.PrixGarantiDetails.COMPANY_NAME.getValue(),Enums.PrixGarantiDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
