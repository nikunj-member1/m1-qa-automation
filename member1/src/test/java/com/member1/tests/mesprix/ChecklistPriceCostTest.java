...
import com.member1.pages.customer.product.commonpages.BasketPage;
import com.member1.pages.customer.product.commonpages.FaqEtServiceClientPage;
import com.member1.pages.customer.product.commonpages.GeneralConditionPage;
import com.member1.pages.customer.product.commonpages.HomePage;
import com.member1.pages.customer.product.commonpages.MerciPage;
import com.member1.pages.customer.product.commonpages.OrderConfirmationPage;
import com.member1.pages.customer.product.commonpages.PaymentPage;
import com.member1.pages.customer.product.commonpages.PersonalDataPage;
import com.member1.pages.customer.product.commonpages.ProductDetailsPage;
import com.member1.pages.customer.product.mesprix.ContactUsPage;
import com.member1.pages.customer.product.pricecost.MembershipPage;
import com.member1.pages.data.DataProvider;
import com.member1.pages.data.Enums;

public class ChecklistPriceCostTest extends BaseDriverManager {
	...
	public void TC_PSP_01_VerifySubscribePageNavigation() {
		...
		try {
			...
			Report.info("Open " + PRIXCOUTANT_URL + " in " + BROWSER_NAME + " browser.");

			HomePage homePage = new HomePage(getDriver());

			homePage.navigateURL(PRIXCOUTANT_URL);
			...
			Report.info("Click on Prix cost logo on Header.");
			headerFooter.clickOnPriceCostLogo();
	...
	//appears payment page same as product purchase > payment page // card payment issue  
	@Test
	public void TC_PSP_02_VerifyEmailAfterPurchaseMembership() {
		...
		try {
			...
			//appears payment page same as product purchase > payment page
...
//			}
		...
		//	String subscriptionPlanName = "S’abonner pour 25€/mois en prélèvement trimestriel (75€/trimestre)";
			...
			String websiteName = "Prix-Coutant";
			...
			String expectedSubscriptionPriceText = Enums.PrixCostDetails.MONTH_PRICE.getValue(); 
			...
			String expectedWebsiteLegalAddressDetails = Enums.PrixCostDetails.COMPANY_ADDRESS.getValue(); 
			...
			String expectedWebsiteLegalEmail = Enums.PrixCostDetails.EMAIL.getValue(); 
			...
			String expectedWebsiteHelpSectionEmail = Enums.PrixCostDetails.EMAIL.getValue(); 
			...
			String expectedWebsiteHelpSectionContactNumber = Enums.PrixCostDetails.CONTACT_NUMBER.getValue(); 
	...
	//failed not getting payment method error
	@Test
	public void TC_PSP_05_TC_PSP_07_VerifyEmailAfterPurchaseProduct() {
		...
		try {
			...
			String productUrl = "https://prix-coutant.com/product/clip-pour-selfies-pour-animaux-familiers-pefie-innovagoods/";			
			...
			//getting no method for payment error[Sorry, it seems that there are no available payment methods for your state. Please contact us if you require assistance or wish to make alternate arrangements.]
	...
	public void TC_PSP_06_VerifyProductOrderOnBackend() {
		try {
			...
			if (paymentPage.isBillingDetailsTitleDisplayed()) {
				Report.pass("'Détails de facturation' title on Payment page.", getScreenshot(getDriver()));
			} else {
				Report.fail("'Détails de facturation' title on Payment page.", getScreenshot(getDriver()));
			}
			...
			String backendURL = PRIXCOUTANT_URL + "wp-admin/";
			
			Report.info("Navigate to '"+backendURL+"' url on browser.");
			loginPage.navigateToWebsiteBackEnd(backendURL);		
						
			if (loginPage.isPriceCostLogoDisplayed()) {
				Report.pass("Price Cost logo on Login page.", getScreenshot(getDriver()));
			} else {
				Report.fail("Price Cost logo on Login page.", getScreenshot(getDriver()));
			}
	...
	public void TC_PSP_15_VerifyCompanyNameOnLegalTerms() {
		...
		try {
			...
			// Home page > Header
			String email = Enums.PrixCostDetails.EMAIL.getValue();			
			...
			String contactNumber = Enums.PrixCostDetails.CONTACT_NUMBER.getValue();
			...
			String monthPrice = Enums.PrixCostDetails.MONTH_PRICE.getValue();
			...
			// Home page > Footer
			String companyNameWithAddress = Enums.PrixCostDetails.COMPANY_NAME.getValue() + " " + Enums.PrixCostDetails.COMPANY_ADDRESS.getValue();
			int actualCompanyNameWithAddressCount = headerFooter.getCompanyFullAddressCountOnFooter(Enums.PrixCostDetails.COMPANY_NAME.getValue(),Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
			...
			email = Enums.PrixCostDetails.EMAIL.getValue();			
			...
			contactNumber = Enums.PrixCostDetails.CONTACT_NUMBER.getValue();
			...
			companyNameWithAddress = Enums.PrixCostDetails.COMPANY_NAME.getValue() + " " + Enums.PrixCostDetails.COMPANY_ADDRESS.getValue();
			actualCompanyNameWithAddressCount = headerFooter.getCompanyFullAddressCountOnFooter(Enums.PrixCostDetails.COMPANY_NAME.getValue(),Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
...
//			}
//			
//			actualCompanyNameWithAddressCount = membershipPage.getCompanyAddressCountOnModal(Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
//			expectedCompanyNameWithAddressCount = 1;
//			
//			if (actualCompanyNameWithAddressCount==expectedCompanyNameWithAddressCount) {
...
//			}
//			
//			actualCompanyNameWithAddressCount = membershipPage.getCompanyNameWithAddressCountOnModal(Enums.PrixCostDetails.COMPANY_NAME.getValue(),Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
//			expectedCompanyNameWithAddressCount = 1;
//			
//			if (actualCompanyNameWithAddressCount==expectedCompanyNameWithAddressCount) {
...
//			}
//					
//			bothPrice = Enums.PrixCostDetails.BOTH_PRICE.getValue();
...
//			}
//			
//			bothPrice = Enums.PrixCostDetails.MONTH_TRIMESTER.getValue();
//			actualPriceCount = membershipPage.getBothPriceCountOnModal(bothPrice);
//			expectedPriceCount = 1;
//			
//			if (actualPriceCount==expectedPriceCount) {
...
//			}
			...
			String companyName = Enums.PrixCostDetails.COMPANY_NAME.getValue();
			int actualCompanyNameCount = personalDataPage.getCompanyNameCount(Enums.PrixCostDetails.COMPANY_NAME.getValue());
			...
			String companyAddress = Enums.PrixCostDetails.COMPANY_ADDRESS.getValue();
			...
			actualCompanyNameWithAddressCount = personalDataPage.getCompanyNameWithAddressCount(Enums.PrixCostDetails.COMPANY_NAME.getValue(),Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			actualCompanyNameWithAddressCount = generalConditionPage.getCompanyNameAndAddressCount(Enums.PrixCostDetails.COMPANY_NAME.getValue(),Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
			...
			actualCompanyNameWithAddressCount = generalConditionPage.getCompanyNameWithAddressCount(Enums.PrixCostDetails.COMPANY_NAME.getValue(),Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			int actualCompanyNameAndAddressCount = paymentPage.getCompanyNameAndAddressCount(Enums.PrixCostDetails.COMPANY_NAME.getValue(),Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
			...
			actualCompanyNameWithAddressCount = paymentPage.getCompanyNameWithAddressCount(Enums.PrixCostDetails.COMPANY_NAME.getValue(),Enums.PrixCostDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
