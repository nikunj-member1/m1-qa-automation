...
public class ChecklistPrixVipTest extends BaseDriverManager {
	...
	public void TC_PSP_01_VerifySubscribePageNavigation() {
		...
		try {
			...
			Report.info("Open " + PRIXVIP_URL + " in " + BROWSER_NAME + " browser.");

			HomePage homePage = new HomePage(getDriver());

			homePage.navigateURL(PRIXVIP_URL);
			...
			Report.info("Click on Prix vip logo on Header.");
			headerFooter.clickOnPrixVipLogo();
	...
	public void TC_PSP_02_VerifyEmailAfterPurchaseMembership() {
		...
		//	String subscriptionPlanName = "S’abonner pour 25€/mois en prélèvement trimestriel (75€/trimestre)";
			...
			String expectedSubscriptionPriceText = Enums.PrixVipDetails.MONTH_PRICE.getValue(); 
			...
			String expectedWebsiteLegalAddressDetails = Enums.PrixVipDetails.COMPANY_ADDRESS.getValue(); 
			...
			String expectedWebsiteLegalEmail = Enums.PrixVipDetails.EMAIL.getValue(); 
			...
			String expectedWebsiteHelpSectionEmail = Enums.PrixVipDetails.EMAIL.getValue(); 
			...
			String expectedWebsiteHelpSectionContactNumber = Enums.PrixVipDetails.CONTACT_NUMBER.getValue(); 
	...
	//fail card issue //privacy checkbox selection issue
	@Test
	public void TC_PSP_05_TC_PSP_07_VerifyEmailAfterPurchaseProduct() {
		...
		try {
			...
			String productUrl = "https://prix-vip.com/product/clip-pour-selfies-pour-animaux-familiers-pefie-innovagoods/";			
...
//			}		
			...
			String backendURL = PRIXVIP_URL + "wp-admin/";
			
			Report.info("Navigate to '"+backendURL+"' url on browser.");
			loginPage.navigateToWebsiteBackEnd(backendURL);		
						
			if (loginPage.isPrixVipLogoDisplayed()) {
				Report.pass("Prix vip logo on Login page.", getScreenshot(getDriver()));
			} else {
				Report.fail("Prix vip logo on Login page.", getScreenshot(getDriver()));
			}
...
//			}		
	...
	public void TC_PSP_15_VerifyCompanyNameOnLegalTerms() {
		...
		try {
			...
			// Home page > Header
			String email = Enums.PrixVipDetails.EMAIL.getValue();			
			...
			String contactNumber = Enums.PrixVipDetails.CONTACT_NUMBER.getValue();
			...
			String monthPrice = Enums.PrixVipDetails.MONTH_PRICE.getValue();
			...
			// Home page > Footer
			String companyNameWithAddress = Enums.PrixVipDetails.COMPANY_NAME.getValue() + " " + Enums.PrixVipDetails.COMPANY_ADDRESS.getValue();
			int actualCompanyNameWithAddressCount = headerFooter.getCompanyFullAddressCountOnFooter(Enums.PrixVipDetails.COMPANY_NAME.getValue(),Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
			...
			email = Enums.PrixVipDetails.EMAIL.getValue();			
			...
			contactNumber = Enums.PrixVipDetails.CONTACT_NUMBER.getValue();
			...
			companyNameWithAddress = Enums.PrixVipDetails.COMPANY_NAME.getValue() + " " + Enums.PrixVipDetails.COMPANY_ADDRESS.getValue();
			actualCompanyNameWithAddressCount = headerFooter.getCompanyFullAddressCountOnFooter(Enums.PrixVipDetails.COMPANY_NAME.getValue(),Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
		...
		//	getDriver().switchTo().alert().accept();
			...
			actualCompanyNameWithAddressCount = membershipPage.getCompanyAddressCountOnModal(Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			actualCompanyNameWithAddressCount = membershipPage.getCompanyNameWithAddressCountOnModal(Enums.PrixVipDetails.COMPANY_NAME.getValue(),Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			bothPrice = Enums.PrixVipDetails.BOTH_PRICE.getValue();
			...
			bothPrice = Enums.PrixVipDetails.MONTH_TRIMESTER.getValue();
			actualPriceCount = membershipPage.getBothPriceCountOnModal(bothPrice);
			expectedPriceCount = 1;
...
//			}
			...
			String companyName = Enums.PrixVipDetails.COMPANY_NAME.getValue();
			int actualCompanyNameCount = personalDataPage.getCompanyNameCount(Enums.PrixVipDetails.COMPANY_NAME.getValue());
			...
			String companyAddress = Enums.PrixVipDetails.COMPANY_ADDRESS.getValue();
			...
			actualCompanyNameWithAddressCount = personalDataPage.getCompanyNameWithAddressCount(Enums.PrixVipDetails.COMPANY_NAME.getValue(),Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			actualCompanyNameWithAddressCount = generalConditionPage.getCompanyNameAndAddressCount(Enums.PrixVipDetails.COMPANY_NAME.getValue(),Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
			...
			actualCompanyNameWithAddressCount = generalConditionPage.getCompanyNameWithAddressCount(Enums.PrixVipDetails.COMPANY_NAME.getValue(),Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
			...
			int actualCompanyNameAndAddressCount = paymentPage.getCompanyNameAndAddressCount(Enums.PrixVipDetails.COMPANY_NAME.getValue(),Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
			...
			actualCompanyNameWithAddressCount = paymentPage.getCompanyNameWithAddressCount(Enums.PrixVipDetails.COMPANY_NAME.getValue(),Enums.PrixVipDetails.COMPANY_ADDRESS.getValue());
			expectedCompanyNameWithAddressCount = 1;
